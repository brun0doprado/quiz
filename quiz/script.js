...
var card_nenhum = document.getElementById("card_nenhum");
...
function escreve_nenhum(){
    txt_plano.value = "Nenhum escolhido, tente novamente"
}
...
function reiniciar_quiz(){
    card_nenhum.style.display = "none";
    tela_itens.style.display = "block";
        ...
        if(txt_finan.value == "Não" || txt_pdv.value == "Não" || txt_cupom.value == "Não"){
            if(txt_estoque.value == "Não"){
                if(txt_boleto.value == "Não"){
                        ...
                        card_elite.style.display = "none";
                        card_pro.style.display = "none";
                        card_nenhum.style.display = "block"
                        escreve_nenhum();
                    }
                }
            }
...
btn_5.addEventListener("click", gerar_resultado);